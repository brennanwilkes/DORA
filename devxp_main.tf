...
output "DORA-worker-c_eip-public-ip" {
  value     = aws_instance.DORA-worker-c.public_dns
  sensitive = false
}
...
output "DORA-worker-a_eip-public-ip" {
  value     = aws_instance.DORA-worker-a.public_dns
  sensitive = false
}
...
output "DORA-worker-b_eip-public-ip" {
  value     = aws_instance.DORA-worker-b.public_dns
  sensitive = false
}
...
output "DORA-worker-d_eip-public-ip" {
  value     = aws_instance.DORA-worker-d.public_dns
  sensitive = false
}
...
output "DORA-worker-e_eip-public-ip" {
  value     = aws_instance.DORA-worker-e.public_dns
  sensitive = false
}
...
output "DORA-scheduler_eip-public-ip" {
  value     = aws_instance.DORA-scheduler.public_dns
  sensitive = false
}
